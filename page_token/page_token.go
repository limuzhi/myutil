...
var (
	ErrInvalidToken         = errors.New(400, "PAGE_TOKEN_FAILED", "The field `page_token` is invalid")
	ErrOverdueToken         = errors.New(400, "PAGE_TOKEN_OVERDUE", "The field `page_token` is overdue")
	ErrOverMaxPageSizeToken = errors.New(400, "PAGE_TOKEN_OVERMAXPAGESIZE", "The field `page_token` is over max page size")
	ErrInvalidPageSize      = errors.New(400, "PAGE_TOKEN_PAGESIZE_FAILED", "The page size provided must not be negative.")
)

const (
	defaultMaxIndex    = 0
	defaultMaxElements = 0
	defaultSalt        = "demo-page"
